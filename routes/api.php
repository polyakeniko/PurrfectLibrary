...
//partners
Route::get('/books/popular', [BookApiController::class, 'getPopularBooks']);
Route::get('/books/newest', [BookApiController::class, 'getNewestBooks']);
Route::get('/books/search', [BookApiController::class, 'searchBooks']);
Route::post('/buy', [BookApiController::class, 'buyItems']);
